...
**Types of Data:**
- Compound Data definitions (Dictionary)
- Arbitrary sized definitions (Lists)
 
> The structure of the information -> determines the struture of the data -> determines the structure of the templates -> determines the structure of the functions -> determines the structure of the program